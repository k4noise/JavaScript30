// Get your shorts on - this is an array workout! // ## Array Cardio Day 1 //
...
const sortedInBirthdays = inventors.sort((a, b) => a.year - b.year);
console.table(sortedInBirthdays);
...
const sortedByLastName = people.sort(
  (people1, people2) => people1.lastName > people2.lastName
);
...
const transportation = data.reduce((obj, item) => {
  obj[item] >= 0 ? obj[item]++ : (obj[item] = 0);
  return obj;
}, {});

console.dir(transportation);
